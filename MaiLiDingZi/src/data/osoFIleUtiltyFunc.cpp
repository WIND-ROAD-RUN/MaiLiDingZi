	...
	const cdm::ScoreConfig& config, double areaFactor, double scoreFactor)
{
	...
	result[ClassId::siLie].areaRange = { 0,config.siLieArea };
	result[ClassId::siLie].scoreRange = { 0,config.siLieScore };

	result[ClassId::queShi].areaRange = { 0,config.queShiArea };
	result[ClassId::queShi].scoreRange = { 0,config.queShiScore };
	...
	const cdm::ScoreConfig& config)
{
	...
	result[ClassId::siLie].isEnable = config.siLie;
	result[ClassId::queShi].isEnable = config.queShi;
