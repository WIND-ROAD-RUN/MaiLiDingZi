...
void findHolesInMask(std::vector<rw::DetectionRectangleInfo>& hollowRects, const std::pair<int, int>& roiOffset,
	int ignoreBorderX, int ignoreBorderY, const rw::DetectionRectangleInfo& bodyInfo)
{
...
std::vector<rw::DetectionRectangleInfo> filterProWithShieldWithoutBody(
	const std::vector<rw::DetectionRectangleInfo>& hollowRects, const std::vector<rw::DetectionRectangleInfo>& shields)
{
...
#pragma region build defect draw
		...
		imageProcessContext_PreProcess.defectDrawCfg.classIdWithConfigMap[ClassId::body].isDisAreaText = false;
		imageProcessContext_PreProcess.defectDrawCfg.classIdWithConfigMap[ClassId::body].isDisScoreText = false;
		imageProcessContext_PreProcess.defectDrawCfg.classIdWithConfigMap[ClassId::body].isDisName = false;
		imageProcessContext_PreProcess.defectDrawCfg.classIdWithConfigMap[ClassId::body].isDrawMask = false;
