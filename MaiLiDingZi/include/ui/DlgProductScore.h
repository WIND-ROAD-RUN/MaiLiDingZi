...
private slots:
	...
	void rbtn_silieEnable_checked();
	void pbtn_silieSimilarity_clicked();
	void pbtn_silieArea_clicked();
	void rbtn_queshiEnable_checked();
	void pbtn_queshiSimilarity_clicked();
	void pbtn_queshiArea_clicked();
